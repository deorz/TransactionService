...
urlpatterns = [
    ...
    path('transaction_history/order_by/<str:order_by>/',
         views.TransactionHistoryView.as_view(),
         name='transaction_history_ordered'),
    path('transaction_history/sort_by/<str:name>/',
         views.TransactionHistoryView.as_view(),
         name='transaction_history_sorted'),
